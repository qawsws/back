                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <form action="/member/remove" method="post" onsubmit="return confirm('정말 탈퇴하시겠습니까?');" style="display:inline;">
                                <button type="submit" class="nav-link btn btn-link p-0" style="color: #0d6efd;">회원탈퇴</button>
                            </form>
                        </div>
                        </div>
                    </div>
