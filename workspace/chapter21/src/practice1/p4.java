...
public class p4 {
	...
	public static void main(String[] args) {
		...
		ArrayList<Student> map = new ArrayList<>();
		map.add(new Student("홍길동","모바일","1",4.1));
		map.add(new Student("이재문","안드로이드","2",3.9));
		map.add(new Student("김남윤","웹공학","3",3.5));
		map.add(new Student("최찬미","빅데이터","4",4.25));
		map.add(new Student("정영웅","컴퓨터공학","5",3.0));
